...
windows.RestartManagerConstants = {
    // https://msdn.microsoft.com/en-us/library/windows/desktop/aa373674.aspx
    CCH_RM_MAX_APP_NAME: 255,
    CCH_RM_MAX_SVC_NAME: 63,

    // https://msdn.microsoft.com/en-us/library/windows/desktop/aa373675.aspx
    RmRebootReasons: {
    ...
    // RestartManager.h
    CCH_RM_SESSION_KEY: 16 * 2 + 1, //  sizeof(GUID) * 2 + 1

    // https://msdn.microsoft.com/en-us/library/windows/desktop/aa373670.aspx
    RmAppTypes: {
        RmUnknownApp:   0,
        RmMainWindow:   1,
        RmOtherWindow:  2,
...
var rmc = windows.RestartManagerConstants;
...
var tCharArray = arrayType(t.TCHAR);

windows.RM_PROCESS_INFO = Struct([
    [windows.RM_UNIQUE_PROCESS, "process"],
    [arrayType(t.TCHAR, rmc.CCH_RM_MAX_APP_NAME+1), "strAppName"],
    [arrayType(t.TCHAR, rmc.CCH_RM_MAX_SVC_NAME+1), "strServiceShortName"],
...
// windows.RM_PROCESS_INFO = Struct({
//     process: windows.RM_UNIQUE_PROCESS,
//     strAppName: arrayType(t.TCHAR, rmc.CCH_RM_MAX_APP_NAME),
//     strServiceShortName: arrayType(t.TCHAR, rmc.CCH_RM_MAX_APP_NAME),
//     applicationType: t.DWORD,
//     appStatus: t.ULONG,
//     tSSessionId: t.DWORD,
//     bRestartable: t.BOOL
// });

windows.RM_PROCESS_INFO_ARRAY = arrayType(windows.RM_PROCESS_INFO);
var uintPtr = ref.refType(t.UINT);
...
windows.restartManager = ffi.Library("rstrtmgr", {
    ...
    "RmGetList": [
        t.DWORD, [ t.DWORD, uintPtr, uintPtr, windows.RM_PROCESS_INFO_ARRAY, t.LPDWORD ]
    ]
});

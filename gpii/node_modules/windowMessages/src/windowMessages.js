 ...
 * @param {Number} message.msg The message to be sent.
 * @param {Object} message.wparam The wparam to be passed to SendWindowNotifyMessageW function.
 * @param {Object} message.lparam The lparam to be passed to SendWindowNotifyMessageW function.
 */

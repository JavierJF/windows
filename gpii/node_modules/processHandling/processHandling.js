...
/**
 * Sends a WM_CLOSE using a external signed application.
 *
 * @return 0
 */
gpii.windows.closeDragonHome = function () {
    var options = {};
    var filename = "dragonbar.exe";
    ...
    gpii.windows.enumerateWindows(function (hwnd) {
        ...
        if (pids.indexOf(windowPid) !== -1) {
            var senderPath = path.join(__dirname, "executable\\SendMessage.exe");
            child_process.execSync("\"" + senderPath + "\"" + " " + hwnd + " 16 0 0");
        }
    });
...
fluid.defaults("gpii.windows.closeDragonHome", {
